...
" Version:	v3.13
" Project:	https://github.com/arfanamd/myVimSetup - Termux
"
...
nnoremap <silent> ,skl :call fzf#run({'sink':'.!cat', 'source':'find $HOME/.vim/skeleton/ \| sed -n 1!P', 'down':'25%', 'options':'-e --border=horizontal --prompt="search: " --no-info --no-unicode --no-color --no-bold --layout=reverse-list'})<CR>M
...
hi BlkWht		guibg=#000000 guifg=#f1faee cterm=bold
hi WhtBlk		guibg=#f1faee guifg=#000000 cterm=bold
...
hi BlkGry		guibg=#000000 guifg=#2f3c3c cterm=none
hi GryWht		guibg=#2f3c3c guifg=#f1faee cterm=bold
hi BlkRed		guibg=#000000 guifg=#e63946 cterm=none
...
hi TabLine		guibg=#000000 guifg=#f1faee cterm=none
hi TabLineSel	guibg=#f1faee guifg=#000000 cterm=bold
hi TabLineFill	guibg=#000000 guifg=#2f3c3c cterm=none
hi PmenuSel		guibg=#3c5a92               cterm=none
hi Pmenu		guibg=#5d5c62               cterm=none
hi LineNr		guibg=#000000 guifg=#c0c0c0 cterm=none
...
function! QuickFixLine()
	let statusline = ""
	let statusline .= "%#BlkRed#════%#GryWht# 🔒 GNU Compiler Debug Report %#BlkRed#"
